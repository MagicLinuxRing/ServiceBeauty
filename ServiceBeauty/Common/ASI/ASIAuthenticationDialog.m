...
//        [[sharedDialog presentingViewController] dismissModalViewControllerAnimated:YES];
        [[sharedDialog presentingViewController] safeDismissModalViewControllerAnimated:YES];
    } else {
//        [[sharedDialog parentViewController] dismissModalViewControllerAnimated:YES];
        [[sharedDialog parentViewController] safeDismissModalViewControllerAnimated:YES];
    }
...
//            [[self presentingViewController] dismissModalViewControllerAnimated:YES];
            [[self presentingViewController] safeDismissModalViewControllerAnimated:YES];
        } else {
//            [[self parentViewController] dismissModalViewControllerAnimated:YES];
            [[self parentViewController] safeDismissModalViewControllerAnimated:YES];
        }
...
//	[[self presentingController] presentModalViewController:self animated:YES];
    [[self presentingController] safePresentModalViewController:self animated:YES];
}
